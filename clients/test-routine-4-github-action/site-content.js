...
window.SITE_CONTENT_DEFAULTS = {
  ...
  artisan: {
    nom:             "TEST ROUTINE 4 - GitHub Action",
    metier:          "Menuisier sur mesure",
    slogan:          "Menuisier à Argenteuil — fabrication et pose sur mesure, un savoir-faire artisanal à votre service.",
    ville:           "Argenteuil",
  ...
  seo: {
    titre:       "TEST ROUTINE 4 - GitHub Action — Menuisier sur mesure à Argenteuil",
    description: "Menuisier à Argenteuil, fabrication et pose sur mesure. Devis gratuit, approche sérieuse et classique.",
  ...
  mentionsLegales: {
    editeur:   "TEST ROUTINE 4 - GitHub Action",
