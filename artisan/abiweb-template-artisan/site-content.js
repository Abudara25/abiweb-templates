...
window.SITE_CONTENT_DEFAULTS = {
  ...
  artisan: {
    nom:             "[NOM DE L'ARTISAN / ENTREPRISE]",
    metier:          "[MÉTIER · Ex: Plombier-chauffagiste]",
  ...
  seo: {
    titre:       "[NOM CLIENT] — [MÉTIER] à [VILLE]",
    description: "[Description 150 caractères max — Ex: Plombier-chauffagiste à Saint-Gratien. Devis gratuit, intervention sous 48h, zone 30km.]",
  ...
  mentionsLegales: {
    editeur:   "[NOM DE L'ARTISAN / ENTREPRISE]",
